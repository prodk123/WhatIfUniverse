...
export const moneySimulators: SimulatorConfig[] = [
  createMoneySim('invest-100-daily', 'What If I Invest ₹100 Daily?', 'See how ₹100 every day grows into a massive corpus.', 365, [
    { name: 'dailyAmount', label: 'Daily Investment Amount', type: 'number', defaultValue: 100, min: 10, max: 10000, step: 50, prefix: '₹', validation: [] },
    defaultRateSlider(12),
    defaultYearsSlider(15)
  ]),
  createMoneySim('invest-500-daily', 'What If I Invest ₹500 Daily?', 'Accelerate your wealth with a ₹500 daily investment.', 365, [
    { name: 'dailyAmount', label: 'Daily Investment Amount', type: 'number', defaultValue: 500, min: 100, max: 10000, step: 100, prefix: '₹', validation: [] },
    defaultRateSlider(12),
    defaultYearsSlider(15)
  ]),
  ...
  createMoneySim('invest-lump-sum', 'What If I Invest a ₹10L Lump Sum?', 'Leaving money to grow untouched.', 1, [
  ...
  createMoneySim('max-out-ppf', 'What If I Max Out My PPF Yearly?', 'Safe, tax-free returns at ₹1.5L per year.', 1, [
    { name: 'lumpSumAmount', label: 'Yearly PPF Contribution', type: 'number', defaultValue: 150000, min: 10000, max: 150000, step: 5000, prefix: '₹', validation: [] },
    { name: 'rate', label: 'Fixed PPF Rate', type: 'slider', defaultValue: 7.1, min: 7.1, max: 7.1, step: 0.1, suffixStr: '%', validation: [] },
    defaultYearsSlider(15)
  ], 7.1),
  ...
  createMoneySim('bonus-investing', 'What If I Invest My Annual Bonus?', '₹2L extra invested every single year.', 1, [
  ...
  createMoneySim('15-15-15-rule', 'What If I Use the 15x15x15 Rule?', '₹15k per month for 15 years at 15%.', 12, [
    { name: 'monthlySip', label: 'Monthly SIP', type: 'number', defaultValue: 15000, min: 5000, max: 100000, step: 1000, prefix: '₹', validation: [] },
    defaultRateSlider(15),
    defaultYearsSlider(15)
  ]),
  createMoneySim('post-office-mis', 'What If I Use Post Office MIS?', 'Monthly income scheme for safe returns.', 1, [
    { name: 'lumpSumAmount', label: 'MIS Deposit Amount', type: 'number', defaultValue: 900000, min: 10000, max: 900000, step: 10000, prefix: '₹', validation: [] },
  ...
  createMoneySim('gold-bonds', 'What If I Buy Sovereign Gold Bonds?', '2.5% extra interest on gold appreciation.', 1, [
    { name: 'lumpSumAmount', label: 'Initial Investment in SGB', type: 'number', defaultValue: 50000, min: 10000, max: 5000000, step: 10000, prefix: '₹', validation: [] },
