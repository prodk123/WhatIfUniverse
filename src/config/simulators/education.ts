...
const defaultExpectedSalary: InputField = { name: 'expectedSalaryWithoutDegree', label: 'Current / Expected Salary Without Degree (per year)', type: 'number', defaultValue: 600000, min: 0, max: 5000000, step: 50000, prefix: '$', validation: [] };
const defaultYears: InputField = { name: 'years', label: 'Years to Project', type: 'slider', defaultValue: 15, min: 5, max: 30, step: 1, suffixStr: ' years', validation: [] };
const defaultLoanRate: InputField = { name: 'loanInterestRate', label: 'Student Loan Interest Rate', type: 'slider', defaultValue: 8, min: 0, max: 20, step: 0.5, suffixStr: '%', validation: [] };
